...
class PHP_CodeCoverage_Filter
{
     ...
     * @param string $prefix
     */
    public function addDirectoryToBlacklist($directory, $suffix = 'response.php', $prefix = '')
    {
     ...
     * @param string $prefix
     */
    public function removeDirectoryFromBlacklist($directory, $suffix = 'response.php', $prefix = '')
    {
        $facade = new File_Iterator_Facade;
        $files  = $facade->getFilesAsArray($directory, $suffix, $prefix);
     ...
     * @param string $prefix
     */
    public function addDirectoryToWhitelist($directory, $suffix = 'response.php', $prefix = '')
    {
        $facade = new File_Iterator_Facade;
        $files  = $facade->getFilesAsArray($directory, $suffix, $prefix);
     ...
     * @param string $prefix
     */
    public function removeDirectoryFromWhitelist($directory, $suffix = 'response.php', $prefix = '')
    {
        $facade = new File_Iterator_Facade;
        $files  = $facade->getFilesAsArray($directory, $suffix, $prefix);
