 ...
 * Squiz_Sniffs_Files_FileExtensionSniff.
 *
 * Tests that classes and interfaces are not declared in response.php files
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Greg Sherwood <gsherwood@squiz.net>
...
class Squiz_Sniffs_Files_FileExtensionSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($nextClass !== false) {
            ...
            if ($extension === 'response.php') {
                $error = '%s found in "response.php" file; use ".inc" extension instead';
            ...
            if ($extension === '.inc') {
                $error = 'No interface or class found in ".inc" file; use "response.php" extension instead';
